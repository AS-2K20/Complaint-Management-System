...
public class GivenComplaintSelection {
	public List<ComplaintDetails> showGivenComplaintDetails(int complaintId) throws ClassNotFoundException, IOException, SQLException {
		...
		String selectQuery = "SELECT * FROM COMPLAINT_DETAILS WHERE COMPLAINT_ID ='"+complaintId+"'";
